...
export const KNOWN_PHASES: readonly KnownPhase[] = [
  ...
  {
    phase: "first_quarter",
    utc: "2024-01-18T03:52:00Z",
    description: "Cuarto creciente enero 2024 (USNO)",
  },
  { phase: "full_moon", utc: "2024-01-25T17:54:00Z", description: "Luna llena enero 2024 (USNO)" },
  {
    phase: "last_quarter",
    utc: "2024-02-02T23:18:00Z",
    description: "Cuarto menguante febrero 2024 (USNO)",
  },
  {
    phase: "full_moon",
    utc: "2024-04-23T23:49:00Z",
    description: "Luna llena Rosa abril 2024 (USNO)",
  },
  { phase: "new_moon", utc: "2025-01-29T12:36:00Z", description: "Luna nueva enero 2025 (USNO)" },
  {
    phase: "full_moon",
    utc: "2025-02-12T13:53:00Z",
    description: "Luna llena febrero 2025 (USNO)",
  },
] as const;
