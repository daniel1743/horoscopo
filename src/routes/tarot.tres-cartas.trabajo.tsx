...
const config = threeCardReadings.trabajo;

export const Route = createFileRoute("/tarot/tres-cartas/trabajo")({
  beforeLoad: ({ context }) => {
...
function TarotThreeCardsTrabajoPage() {
  return <ThreeCardExperienceShell readingSlug="trabajo" />;
}
