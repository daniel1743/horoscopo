...
export function FeaturedReadingsSection() {
  ...
  return (
    <section className="relative py-24 overflow-hidden" aria-labelledby="featured-tarot-title">
      ...
      <div className="mx-auto w-full max-w-[var(--container-max-w)] px-[var(--container-px)] relative z-10">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2
            ...
            className="font-display text-[32px] sm:text-[40px] leading-[1.1] text-ink max-w-2xl"
          >
            {config.title}
          </h2>
        </div>
